...
import { claimOrderPaid, markOrderApplied } from "@/lib/billing/orders";
...
const ORDER_COLUMNS =
  "id, subscription_id, app_cabinet_id, app_user_id, plan, role, extra_collaborators, amount_cents, currency, status, monetico_reference, monetico_order_date, applied_at, billing_snapshot";
