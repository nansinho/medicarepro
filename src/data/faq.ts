/**
 * Questions fréquentes — source de vérité unique.
 * Utilisées par le composant Faq (accordéon, client) et par le schema.org
 * FAQPage (JSON-LD) de la page Tarifs (serveur).
 */
