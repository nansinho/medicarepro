...
/* ------- Podologie (empreintes de pas, semelle orthopédique) -------
   Clés déclarées dans IconKeySchema (src/lib/cms/sections.schema.ts) et
   branchées dans les maps ICONS de HomeFeatureScroll, FeatureShowcase et
   de la page bilans. */

export function Foot(props: IconProps) {
  return (
    <svg {...base} strokeWidth={1.6} {...props}>
...
export function Insole(props: IconProps) {
  return (
    <svg {...base} strokeWidth={1.6} {...props}>
      <path d="M12 2c3.6 0 6 2.9 6 6.3 0 2.6-1.6 4.4-1.6 6.9v2.4a4.4 4.4 0 0 1-8.8 0v-2.4C7.6 12.7 6 10.9 6 8.3 6 4.9 8.4 2 12 2Z" />
      <path d="M9.3 7h5.4M9.6 10h4.8" />
    </svg>
  );
}
