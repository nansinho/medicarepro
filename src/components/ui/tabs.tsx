...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        /* Les variantes `dark:` d'origine ont été retirées : écrites pour la
           palette grise de shadcn, elles produisaient des remplissages
           boueux sur le navy du back office une fois la variante active. Les
           tokens sémantiques suffisent, ils s'inversent d'eux-mêmes. */
